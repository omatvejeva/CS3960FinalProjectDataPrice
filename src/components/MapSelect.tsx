...
import worldMap from 'echarts4/map/json/world.json'
import chinaMap from 'echarts4/map/json/china.json'
import 'echarts4/map/js/world.js'
import { Box, Chip, FormControl, InputLabel, MenuItem, OutlinedInput, Stack, Typography, Button, Select, SelectChangeEvent, FormControlLabel, Checkbox, Grid, ListSubheader } from '@mui/material'
...
export default function MapSelect({propCountries,onCountriesChange}: Props) {

    const mapNode = useRef(null)
    const [countries,setCountries] = useState<string[]>(propCountries)
    
    const [countryMap,setCountryMap] = useState<any>(null)
    ...
    useLayoutEffect(()=>{
        ...
        setCountryMap(()=>{
            let temp = echarts4.init(mapNode.current)
            ...
            temp.on("mapselectchanged",function(params:any){
                //console.log(params)
  ...
  return (
    <Stack spacing={2} alignItems={'center'}>
        ...
        <Box display='flex' justifyContent={'center'} height={'300px'} width={'100%'} ref={mapNode}></Box>
